...
def analyze_platforms(
    ...
    for platform in platforms:
        ...
        surface = evaluate_surface_threat(distance, iceberg.keel_depth, platform.water_depth)

        # Subsea assets: only consider threats within 25 NM
        intersects = intersects_within_radius_nm(platform.location, track, radius_nm=25.0)
        subsea = evaluate_subsea_threat(intersects, iceberg.keel_depth, platform.water_depth)
...
def build_map_overlay(
    ...
    platform_points = [p.location for p in platforms]
